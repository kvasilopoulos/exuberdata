...
The goal of `exuberdata` is to provide critcal values for the `exuber` package. 
...
Due to the large package size `exuberdata` cannot be distributed as a conventional 
CRAN package. However, there are a couple alternatives for installation.
...
Finally, it can be installed through [github repo](https://github.com/kvasilopoulos/exuberdata).
